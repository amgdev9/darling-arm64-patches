...
set(ROOTFS "your_rootfs_path")

set(CMAKE_C_FLAGS "--target=aarch64-linux-gnu --sysroot=${ROOTFS}")
set(CMAKE_CXX_FLAGS "--target=aarch64-linux-gnu --sysroot=${ROOTFS}")
set(CMAKE_EXE_LINKER_FLAGS "--target=aarch64-linux-gnu --sysroot=${ROOTFS} -fuse-ld=lld")
set(CMAKE_SHARED_LINKER_FLAGS "--target=aarch64-linux-gnu --sysroot=${ROOTFS} -fuse-ld=lld")
